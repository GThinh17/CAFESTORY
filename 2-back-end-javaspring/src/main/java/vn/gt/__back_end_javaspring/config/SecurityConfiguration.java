        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/login", "/api/blogs", "/api/signup", "/users/{id}", "/api/pages/{id}",
                                ...
                                "/api/pages/top-followers", "api/reviewers", "/api/shares/**", "/api/blogs/{blogId}","/api/reviewers/top/follower-desc","/api/shares/by-user","/api/tags/by-useridtag/{userId}","/api/blogs/admin/review-queue")
                        .permitAll()
